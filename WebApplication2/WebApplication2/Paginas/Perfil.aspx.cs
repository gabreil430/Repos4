...
namespace WebApplication2.Paginas
{
    public partial class Perfil : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            string ID = Session["IDperfil"].ToString();
            string Tipo = Session["Tipoperfil"].ToString();
            //string ID = "16";
            //string Tipo = "idosos";
        ...
        protected void btnVisuComent_Click(object sender, EventArgs e)
        {
            Response.Redirect("http://localhost:49953/Paginas/visualizar_comentarios");
        }

        protected void btnFazerComent_Click(object sender, EventArgs e)
        {
            Response.Redirect("http://localhost:49953/Paginas/fazer_comentario");
        }
    }
}