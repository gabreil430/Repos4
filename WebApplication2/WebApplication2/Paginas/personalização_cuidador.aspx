 ...
 <h5>Por favor, preencha os campos a seguir para que seu perfil fique ainda mais completo e útil para quem visitá-lo: </h5> <br />
   ...
   <%-- coluna 1--%>
    ...
    <div class="col-lg-12" >
        ...
        <asp:Label runat="server" Text="Esta é uma das partes mais importantes do seu perfil. Informe suas formações, especificações e diferenciais.
         Se preciso, especifique dados mensionados acima. Lembre-se que uma boa descrição auxiliará a encontrar o paciente mais adequado para você." ID="Label1"></asp:Label><br />
       
        <asp:TextBox runat="server" ID="txtDescricao" Width="10000px"  TextMode="MultiLine" Rows="5"></asp:TextBox><br /><br />

       
          <asp:Button  runat="server" Text="Salvar" ID="btnSalvar"   OnClick="" CssClass="btn btn-sucess, content"/>  
